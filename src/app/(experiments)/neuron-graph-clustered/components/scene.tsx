...
export function Scene() {
  ...
  const [controls] = useControls(() => ({
    Appearance: folder({
      ...
      spread: { value: 7.0, min: 2, max: 20, step: 0.5, label: "Spread" },
    ...
    Connections: folder({
      ...
      connectionOpacity: { value: 0.60, min: 0, max: 1, step: 0.05, label: "Connection Opacity" },
      maxConnectionDistance: { value: 4.5, min: 1, max: 15, step: 0.5, label: "Max Connection Distance" },
      lineWidth: { value: 2.0, min: 1, max: 10, step: 0.5, label: "Line Width" },
